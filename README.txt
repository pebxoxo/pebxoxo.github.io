...
FILE TYPES: JavaScript(p5.js), HTML, CSS and media files. Apart from the library files, all code was written by me, no external ideas/algorithms used. 

REFERENCES+INSPIRATIONS: Owls, Language and linguistics, John Cage and his discussion of mushrooms, Mycological models, Vultures by Chinua Achebe, Kes, Peter Whitehead and his falcon copulation hat, The Jewish Kabbalah, The Bible and particularly the book of Daniel, The name of God: YHWH, Borges and his library of babel, Formal logic, Rotting flesh, Osman spare and his chaos magick, The beauty of Arabic calligraphy, Ossifrage. This website reflects a mystical belief in the omnipitent power within the dense web of connections held between all things: the digital and computational because a medium, a canvas, with which to explore the interesting relationship between seemingly disperate taxonomies.

NOTE ON COMMENTING: I have not done in depth commenting on all the code in this project due to its size and largely modular nature, however every HTML  files contains a brief outline of content, each JS file has some brief description of process and each CSS class has an indication of where it is used. The index.html file and the graphic.js file have more detailed comments. Also not that the commenting is, in some capacity, a part of the artwork. I have tried to bear in mind that people can access this source code, and have commented accordingly in parts.
